...
namespace FluxoVendaCartoes
{
    ...
    public class VendaCartoes
    {
        ...
        public void teste()
        {
            ...
            driver.Navigate().GoToUrl("https://www.marisa.com.br/");
            touchActions.Click(driver.FindElement(By.CssSelector("body > main > header > section > nav > div > div.col-xs-2.col-md-2 > div > div > section > div > div.shopping-bag.pull-left > a > img")));
            touchActions.Build();
