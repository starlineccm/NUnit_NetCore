...
namespace FluxoVendaCartoes
{
    ...
    public class VendaCartoes
    {
        ...
        public void SetupTest()
        {
            ...
            //options.AddArgument("window-size=568,320");
        ...
        public void CT001_Cadastro_de_Clientes_Aposentados()
        {
            ...
            driver.FindElement(By.Id("dataNascCad")).SendKeys("27/07/1973");
            print.PrintScreen();
            ...
            //Botão Li e concordo com os termos
            Thread.Sleep(2000);
            driver.FindElement(By.CssSelector("body > form > footer > input")).Click();

            //Anexar a imagem da frente do RG
            Thread.Sleep(2000);
            driver.FindElement(By.Id("photo_37")).SendKeys(@"C:\MARISA\CCM");

            //Anexar a imagem da tras do RG
            driver.FindElement(By.Id("photo_38")).SendKeys(@"C:\MARISA\CCM");
